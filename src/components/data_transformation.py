...
class DataTransformation:
    ...
    def get_data_transformation_object(self):
        ...
        try:
            ...
            # we have created a pipeline which handles missing values using imputer and scaling using scalar
            steps = [
    ...
    def initiate_data_transformation(self,train_path, test_path):
        try:
            ...
            train_arr = np.c_[input_feature_train_arr, np.array(target_feature_train_df)] #combining 2 columns
